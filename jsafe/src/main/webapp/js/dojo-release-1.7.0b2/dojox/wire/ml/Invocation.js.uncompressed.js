...
define("dojox/wire/ml/Invocation", ["dojo","dijit","dojox","dojox/wire/ml/Action"], function(dojo, dijit, dojox){
dojo.getObject("dojox.wire.ml.Invocation", 1);
...
return dojo.getObject("dojox.wire.ml.Invocation");});
