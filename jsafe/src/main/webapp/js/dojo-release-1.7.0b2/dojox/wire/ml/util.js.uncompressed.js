...
define("dojox/wire/ml/util", ["dojo","dijit","dojox","dojox/xml/parser","dojox/wire/Wire"], function(dojo, dijit, dojox){
dojo.getObject("dojox.wire.ml.util", 1);
...
return dojo.getObject("dojox.wire.ml.util");});
