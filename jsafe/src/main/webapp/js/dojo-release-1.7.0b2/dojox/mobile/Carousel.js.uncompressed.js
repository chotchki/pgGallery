...
define("dojox/mobile/Carousel", ["dijit/_WidgetBase","dijit/_Container","dijit/_Contained","./PageIndicator","./SwapView"], function(WidgetBase,Container,Contained,PageIndicator,SwapView){
	// module:
