...
define("dojox/data/StoreExplorer", ["dojo","dijit","dojox","dojox/grid/DataGrid","dojox/data/ItemExplorer","dijit/layout/BorderContainer","dijit/layout/ContentPane"], function(dojo, dijit, dojox){
dojo.getObject("dojox.data.StoreExplorer", 1);
...
return dojo.getObject("dojox.data.StoreExplorer");});
require(["dojox/data/StoreExplorer"]);
