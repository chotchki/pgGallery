...
define("dojox/date/islamic/Date", ["dojo","dijit","dojox","dojo/i18n","dojo/cldr/nls/islamic"], function(dojo, dijit, dojox){
dojo.getObject("dojox.date.islamic.Date", 1);
...
return dojo.getObject("dojox.date.islamic.Date");});
