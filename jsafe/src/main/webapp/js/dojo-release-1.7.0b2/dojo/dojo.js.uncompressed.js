...
(function(
		...
		checkComplete = function(){
			...
			try{
				...
				for(var currentDefOrder, module, i = 0; i < execQ.length;){
					...
					module = execQ[i];
					execModule(module);
					if(currentDefOrder!=defOrder || (1 && checkDojoRequire())){
					...
					1 && isEmpty(waiting) && legacyMode==xd && (legacyMode = sync);
				}
			}finally{
				checkCompleteGuard--;
			}
	...
	if(1){
		var fixupUrl= function(url){
			...
			injectModule = function(module){
				...
				if(1 && req.combo.add(0, module.path, module.url, req)){
					comboPending= 1;
					return;
				}
	...
	if(1){
		// if you want to replace the req.log API, pass in a default config and make 1 falsy
		req.log = function(){
...
define("dojo/dom-construct", ["./_base/kernel", "./_base/sniff", "./_base/window", "./dom", "./dom-prop", "./on"], function(dojo, sniff, win, dom, prop, on){
	// module:
	//		dojo/dom-construct
	// summary:
...
define("dojo/_base/Deferred", ["./kernel", "./lang"], function(dojo){
	// module:
	//		dojo/_base/Deferred
	// summary:
...
define("dojo/dom-prop", ["./_base/kernel", "./_base/sniff", "./_base/lang", "./_base/window", "./dom", "./dom-style"], function(dojo, sniff, lang, win, dom, style){
	// module:
	//		dojo/dom-prop
	// summary:
...
define("dojo/_base/array", ["./kernel", "./lang"], function(dojo){
	// module:
	//		dojo/_base/array
	// summary:
...
define(["../has", "./config", "require", "module"], function(has, config, require, module){
	...
	dojo.version = {
		major: 1, minor: 7, patch: 0, flag: "b2",
	...
	false && has.add("dojo-debug-messages",
