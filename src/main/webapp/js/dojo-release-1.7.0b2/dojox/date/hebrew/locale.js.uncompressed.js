...
define("dojox/date/hebrew/locale", ["dojo","dijit","dojox","dojo/i18n","dojo/cldr/nls/hebrew"], function(dojo, dijit, dojox){
dojo.getObject("dojox.date.hebrew.locale", 1);
define(["dojo/_base/kernel", "dojo/date", "dojo/i18n", "dojo/regexp", "dojo/string", "./Date", "./numerals", "dojo/i18n!dojo/cldr/nls/hebrew"],
	function(d, dd, i18n, regexp, string, hebrewDate, numerals){
...
return dojo.getObject("dojox.date.hebrew.locale");});
