...
define("dojox/help/_base", ["dojo","dijit","dojox","dojox/rpc/Service","dojo/io/script"], function(dojo, dijit, dojox){
dojo.getObject("dojox.help._base", 1);
...
return dojo.getObject("dojox.help._base");});
require(["dojox/help/_base"]);
