...
define("dojox/form/manager/_ValueMixin", ["dojo","dijit","dojox"], function(dojo, dijit, dojox){
dojo.getObject("dojox.form.manager._ValueMixin", 1);
...
return dojo.getObject("dojox.form.manager._ValueMixin");});
