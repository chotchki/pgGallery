...
define("dojox/form/_SelectStackMixin", ["dojo","dijit","dojox"], function(dojo, dijit, dojox){
dojo.getObject("dojox.form._SelectStackMixin", 1);
...
return dojo.getObject("dojox.form._SelectStackMixin");});
