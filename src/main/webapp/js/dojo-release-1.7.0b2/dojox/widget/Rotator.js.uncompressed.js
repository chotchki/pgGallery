...
define("dojox/widget/Rotator", ["dojo","dijit","dojox","dojo/parser"], function(dojo, dijit, dojox){
dojo.getObject("dojox.widget.Rotator", 1);
...
return dojo.getObject("dojox.widget.Rotator");});
