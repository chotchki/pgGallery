...
define("dojox/widget/Iterator", ["dojo","dijit","dojox","dijit/Declaration"], function(dojo, dijit, dojox){
dojo.getObject("dojox.widget.Iterator", 1);
...
return dojo.getObject("dojox.widget.Iterator");});
require(["dojox/widget/Iterator"]);
